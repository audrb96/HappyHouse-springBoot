...
<div style="display: flex; justify-content: center; margin-top: 20px">
    <div class="container text-center mt-3">
        <div class="col-lg-8 mx-auto">
            ...
            <form id="writeform" class="text-left mb-3" method="post" enctype="multipart/form-data" action="${root}/notice/modify">
                <input type="hidden" value="${notice.articleNo}" name="articleNo">
                <div class="form-group">
                    <label for="subject" style="font-size: 20px">제목:</label>
                    <input value="${notice.title }" type="text" class="form-control" id="subject" name="title" placeholder="제목...">
                </div>
                <div class="form-group">
                    <label for="content" style="font-size: 20px">내용:</label>
                    <textarea style="width: 100%; height: 800px;" class="form-control" rows="30" id="content" name="text">${notice.text }</textarea>
                </div>
                <div class="text-center">
                    <button type="submit" id="registerBtn" class="btn btn-outline-primary">수정완료</button>
                </div>
            </form>
        </div>
    </div>
