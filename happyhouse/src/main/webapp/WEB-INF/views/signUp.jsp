  ...
  <body>
    ...
    >
      <div class="form-block p-30 light-gray-bg border-clear">
        <h2 class="title" id="signup-title" style="color: gray;">회원 가입</h2>

        <form class="form-horizontal" method = "post" action="${root}/user/join">
          ...
          <div class="form-group row">
            <div class="ml-md-auto col-md-9">
              <button type="submit" id="sign-button" class="btn btn-group btn-warning btn-animated">등록</button>
            </div>
          </div>
        </form>
      </div>
